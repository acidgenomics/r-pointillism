...
#'   [sanitizeSeuratMarkers()]. Note that an unmodified Seurat markers
#'   `data.frame` will error here by design, since it doesn't consistently
#'   contain Ensembl gene identifiers.
