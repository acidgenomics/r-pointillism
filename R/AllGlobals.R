.formalsList <- list(
    ...
    headerLevel = 2L,
    label = quote(getOption(
        x = "acid.label",
        default = TRUE
    )),
    labelSize = quote(getOption(
        x = "acid.labelSize",
        default = 6L
    )),
    legend = quote(getOption(
        x = "acid.legend",
        default = TRUE
    )),
    pointAlpha = quote(getOption(
        x = "acid.pointAlpha",
        default = 0.85
    )),
    pointSize = quote(getOption(
        x = "acid.pointSize",
        default = 0.75
    )),
    pointsAsNumbers = quote(getOption(
