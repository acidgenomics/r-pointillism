...
params:
  sce_file: "data/YYYY-MM-DD/sce_filtered.rda"
  seurat_name: "seurat"
  pc_compute: 20
  dims_use: FALSE
...
# getMethod("coerce", signature(from = "SingleCellExperiment", to = "seurat"))
...
# This requires python umap-learn to be installed
...
```{r plot_feature_pcs_umap, eval=params$umap}
plotFeatureUMAP(
    object = seurat,
    features = feature_pcs,
    dark = params$dark
