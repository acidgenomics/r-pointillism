...
params:
  ...
  seurat_file: "rds/YYYY-MM-DD/sce_filtered.rds"
  seurat_name: "seurat"
  pc_compute: 20
  dims: FALSE
...
## FIXME Need to take out magrittr pipe here.
markdownHeader("S phase markers", level = 3)
s_genes <- cell_cycle_markers %>%                                        # FIXME
    as_tibble() %>%                                                      # FIXME
    filter(phase == "S") %>%                                             # FIXME
    pull("geneName") %>%                                                 # FIXME
    sort()
print(s_genes)
...
g2m_genes <- cell_cycle_markers %>%                                      # FIXME
    as_tibble() %>%                                                      # FIXME
    filter(phase == "G2/M") %>%                                          # FIXME
    pull("geneName") %>%                                                 # FIXME
    sort()
print(g2m_genes)
